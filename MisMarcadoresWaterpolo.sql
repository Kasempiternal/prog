...
INSERT INTO ` jugadores` VALUES (0,'Antonio','Tony',21,'España',2,1,12,2,'2020-01-31','2021-03-15',1,'0'),(1,'Koldo','Moya',15,'Mexico',5,8,1,9,'2020-01-31','2021-03-15',2,'0'),(2,'Jon','Churruca',25,'España',7,2,6,15,'2020-01-31','2021-03-15',4,'1'),(3,'Aitor','Perez',16,'España ',5,0,15,20,'2020-01-31','2021-03-15',5,'1'),(4,'Izotz','Garcia',27,'Portugal',3,0,31,11,'2020-01-31','2021-03-15',6,'2'),(5,'Juan','Gonzalez',20,'Paraguay',11,3,1,4,'2020-01-31','2021-03-15',3,'1'),(6,'Koldo','Perez',20,'España',1,0,1,20,'2020-01-31','2021-03-15',7,'2'),(7,'Antonio','Cristobal',27,'Serbia',2,0,5,14,'2020-01-31','2021-03-15',8,'2'),(8,'Jose','Perez',30,'España',2,0,8,2,'2020-01-31','2021-03-15',8,'2'),(9,'Jorge','Sanchez',31,'España',1,0,19,9,'2020-01-31','2021-03-15',7,'2'),(10,'Francisco','Gonzalez',28,'EEUU',14,5,25,19,'2020-01-31','2021-03-15',6,'2'),(11,'Pablo','Medina',20,'Montenegro',7,1,24,16,'2020-01-31','2021-03-15',5,'1'),(12,'Pepe','Perez',19,'Serbia',8,0,15,11,'2020-01-31','2021-03-15',4,'1'),(13,'Jon','Trujillo',22,'Serbia',0,3,11,4,'2020-01-31','2021-03-15',3,'1'),(14,'Ander','Moya',25,'Hungria',1,3,14,4,'2020-01-31','2021-03-15',2,'0'),(15,'Anton','Perez',24,'EEUU',1,0,27,5,'2020-01-31','2021-03-15',1,'0'),(16,'Jose','Gonzalez',22,'Italia',12,0,32,18,'2020-01-31','2021-03-15',1,'0');
...
CREATE TABLE `resultados` (
  ...
  CONSTRAINT `nombre_liga` FOREIGN KEY (`liga`) REFERENCES `ligas` (`nombre_liga`)
...
-- Dump completed on 2021-01-18  1:51:36
