...
public class verificaCodigo extends JFrame {
	...
	private void initialize() {
		...
		/**
		 * hay que repetir el mail hasta que se me ocurra otra manera de poder mandar el
		 * mail desde la primera ventana ahora mismo manda el mail y lo confirma en la
		 * misma ventana
		 */
		...
		// POR AHORA ESTE BOTON MANDARA EL CODIGO HASTA QUE ENCONTREMOS OTRA MANERA DE
		// HACERLO MEJOR
