	...
	public void export(JTable table) throws Exception {
	    ...
	    if (chooser.showSaveDialog(null) == JFileChooser.APPROVE_OPTION) {
	        ...
	        try {
	            ...
	            /**
	             * El siguiente bucle lo que hara es primero leer y recorrer la tabla
	             * y segundo crea las celdas que necesita para por ultimo escribir en ellas en el ultimo bucle
	             */
	            ...
	            for (int f = 0; f < table.getRowCount(); f++) {
	             ...
	             for (int f = 0; f < table.getRowCount(); f++) {
	                 ...
	                 for (int c = 0; c < table.getColumnCount(); c++) {
	                	 Cell celda = fila.createCell(c);
	                	 /**
	                	  * va escribiendo dependiendo del tipo de variable
	                	  * Por eso hay dps else
	                	  */
	                	 //Double
